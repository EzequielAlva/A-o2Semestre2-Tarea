...
public class JobSchedulerTest {
    ...
    private JobScheduler newFifoScheduler() {
        JobScheduler fifoScheduler = new JobStrategyFifo();
        return fifoScheduler;
    }

    private JobScheduler newLifoScheduler() {
        JobScheduler lifoScheduler = new JobStrategyLifo();
        return lifoScheduler;
    }

    private JobScheduler newPriorityScheduler() {
        JobScheduler priorityScheduler = new JobStrategyHighestPriority();
        return priorityScheduler;
    }

    private JobScheduler newEffortScheduler() {
        JobScheduler effortScheduler = new JobStrategyMostEffort();
    ...
    @Test
    void testSchedule() {
        JobScheduler aScheduler = new JobStrategyFifo();
